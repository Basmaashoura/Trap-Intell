    ...
    <>
      ...
      <main>
        <div className={styles.page}>
          {/* form panel — order:-1 in CSS so it renders on the left */}
          <div className={styles.formPanel}>
            ...
            <div className={styles.formCard}>
              ...
              {/* Social */}
              <div className={`${styles.formGroup} ${styles.socialOptions}`}>
              ...
              {/* Security note */}
              <div className={`${styles.formGroup} ${styles.securityNote}`}>
                <p>
                  <strong>Security Note:</strong> For your protection, we won't
                  confirm whether an account exists with this email address.
                </p>
              </div>
            </div>
          </div>
